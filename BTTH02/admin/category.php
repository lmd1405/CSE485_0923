...
<div class="main-content vh-100 p-3">
  <div class="m-5">
    <a href="add_category.php" class="btn btn-success"><i class="bi bi-person-add"></i>Thêm mới</a>
  </div>
  <div >
      <table class="table">
          <thead>
          ...
          <?php foreach($TheLoai as $row){?>
             <tr>
                ...
                <th><a href="edit_category.php?id=<?php echo $row[0];?>"><i class="bi bi-pencil-square"></i></a></th>
