        ...
        <div class="m-2 p-3">
            <form action="process_login.php" class="border border-secondary bg-secondary p-4" method="POST">
                <div class="form-group">
                    ...
                    <input name = "username" class="form-control" id="exampleInputEmail1"  placeholder="username">
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-success mb-2 float-end" name="SBlogin">Submit</button>
            </form>
        </div>
