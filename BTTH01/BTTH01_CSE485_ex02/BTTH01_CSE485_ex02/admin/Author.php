...
<div class="main-content vh-100 p-3">
  <div class="m-5">
    <a href="add_author.php" class="btn btn-success"><i class="bi bi-person-add"></i>Thêm mới</a>
  </div>
  <div >
      <table class="table">
          <thead>
             <tr>
                ...
                <th scope="col">Hinh tác giả</th>
                <th scope="col">Sua</th>
                <th scope="col">Xoa</th>
             </tr>
          </thead>
          <tbody>
          <?php foreach($tacgia as $row){?>
             <tr>
                <th><?php echo $row[0];?></th>
                <th><?php echo $row[1];?></th>
                <th><?php echo $row[2];?></th>
                <th><a href="edit_author.php?id=<?php echo $row[0];?>"><i class="bi bi-pencil-square"></i></a></th>
